...
?>
<?php if ( couponseek_get_field('ribbon') || couponseek_get_field('ribbon') != 'none' ) : 
	if ( couponseek_get_field('ribbon') == 'discount' && $regular_price && $sale_price ) :
	...
	elseif ( couponseek_get_field('ribbon') == 'text' && couponseek_get_field('ribbon_text') ) :
