...
<footer class="FOOTER <?php echo esc_attr(couponseek_get_field('footer_text_type', 'option') == 'light' ? 'section-light' : '') ?> <?php echo esc_attr($has_widgets ? 'has-widgets' : '')  ?>">
	...
	<div class="container">
		<div class="row">
			...
			<?php endif; ?>
			<span id="siteseal" style="float: right;"><script async type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=WUFa8dCpWqSDbWJE34zLegvhDfp18ngSD3bS2kvs7UZ0TsopWE9at8WnOhGx"></script>
			</span>
			</div><!-- end col-sm-12 -->
		</div><!-- end row -->
	</div><!-- end container -->
