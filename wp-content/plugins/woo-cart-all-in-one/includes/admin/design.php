...
class VI_WOO_CART_ALL_IN_ONE_Admin_Design {
	...
	protected function add_section_design_sidebar_footer( $wp_customize ) {
		...
		$wp_customize->add_control( new VIWCAIO_Customize_Premium( $wp_customize, 'woo_cart_all_in_one_params_premium[sc_footer_coupon]',
			array(
				'section'  => 'vi_wcaio_design_sidebar_footer',
				'label'    => __( 'Enable Applied Coupons', 'woo-cart-all-in-one' ),
				'choices'    => array(
					'button'    => 'yes',
				)
			)
		...
		$sc_footer_pd_plus= array(
			...
			'cross_sell'   => __( 'Cross-sells Products', 'woo-cart-all-in-one' ),
			'product_featured' => __( 'Featured products', 'woo-cart-all-in-one' ),
			'viewed_product'   => __( 'Recently Viewed products', 'woo-cart-all-in-one' ),
			'select_cat'       => __( 'Select Categories', 'woo-cart-all-in-one' ),
			'select_pd'        => __( 'Select Products', 'woo-cart-all-in-one' ),
			'product_rating'   => __( 'Top Rated Products', 'woo-cart-all-in-one' ),
			'product_upsell'   => __( 'Upsell Products', 'woo-cart-all-in-one' ),
		);
		$wp_customize->add_control(
	...
	protected function add_section_design_sidebar_products( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				'label'    => __( 'Price Style', 'woo-cart-all-in-one' ),
				'section'  => 'vi_wcaio_design_sidebar_products',
				'type'    => 'select',
				'choices' => array(
					'price' => __( 'Product price', 'woo-cart-all-in-one' ),
					'qty' => __( 'Qty & price', 'woo-cart-all-in-one' ),
					'subtotal' => __( 'Product subtotal', 'woo-cart-all-in-one' ),
				),
			)
		);
